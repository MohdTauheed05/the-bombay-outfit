...
import { categories, megaMenu, resolveCollectionFromList, slugifyCategory } from '@/lib/products'
...
export async function generateMetadata({
  ...
  if (!match) return { title: 'Not Found | The Bombay Outfit' }

  return {
    title: `${match} | The Bombay Outfit`,
    description: `Shop ${match} at The Bombay Outfit \u2014 curated menswear, delivered across India.`,
  }
}
...
export default async function CategoryPage({
  ...
  const collection = resolveCollectionFromList(products, slug)
